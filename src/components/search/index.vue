<template>
  <div id="my-search">
    <div class="flex flex-wrap flex-grap">
      ...
      <div v-for="(item, i) in props.list" :key="i" :style="{ width: item.width }">
        ...
        <el-date-picker class="w100" v-else-if="item.type === 'date'" v-model="models[i]" :type="item.pickerType" :placeholder="item.placeholder || '请选择日期'" range-separator="-" :start-placeholder="item.startPlaceholder" :end-placeholder="item.endPlaceholder" />
